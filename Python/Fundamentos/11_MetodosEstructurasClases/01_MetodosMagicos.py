...
# Los métodos mágicos en Python, también llamados métodos dunder (porque comienzan y terminan con doble guion bajo, __), son métodos especiales que Python usa internamente para diferentes operaciones.
# Estos métodos permiten sobrecargar operadores y personalizar el comportamiento de las clases, haciéndolas más intuitivas y poderosas.
